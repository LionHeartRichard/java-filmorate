...
public class DirectorRepository extends BaseRepository<Director> {
	...
	private static final String FIND_ALL_QUERY = "SELECT d.* FROM director d";

	private static final String FIND_BY_ID = "SELECT d.* FROM director d WHERE director_id = ?";

	private static final String FIND_DIRECTORS_BY_FILM_ID = "SELECT d.* FROM director d "
			+ "JOIN film_director fd ON d.director_id = fd.director_id " + "WHERE fd.film_id = ?";
	...
	private static final String DELETE_DIRECTOR_BY_ID = "DELETE FROM director WHERE director_id = ?";

	private static final String DELETE_FILM_DIRECTOR_BY_FILM_ID = "DELETE FROM film_director WHERE film_id = ?";
	...
	public boolean deleteByFilmId(Long id) {
		return delete(DELETE_FILM_DIRECTOR_BY_FILM_ID, id);
	}
}
