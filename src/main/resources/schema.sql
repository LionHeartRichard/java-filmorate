...
CREATE TABLE IF NOT EXISTS FRIEND (
  ...
  CONSTRAINT FRIEND_PERSON_FK_1 FOREIGN KEY (PERSON_ID) REFERENCES PUBLIC.PERSON(PERSON_ID),
  CONSTRAINT FRIEND_PERSON_FK_2 FOREIGN KEY (FRIEND_ID) REFERENCES PUBLIC.PERSON(PERSON_ID)
);
